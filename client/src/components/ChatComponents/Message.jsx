...
export default function Message({
  ...
  const prevIsSameDate =
    prevMessage &&
    new Date(prevMessage.updated_at).toDateString() ===
  ...
  const nextIsSameDate =
    nextMessage &&
    new Date(nextMessage.updated_at).toDateString() ===
      new Date(message.updated_at).toDateString();
  const isLastInGroup =
        ...
        >
          {message.sender_id !== currentUserId && !prevIsSameSender ? (
            <Avatar className="flex-none">
              <AvatarImage
                src={
                  message.sender_avatar_url ? message.sender_avatar_url : null
                }
                alt=""
              />
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              <div
                className={cn(
                  "flex items-center p-3 w-fit max-w-md h-fit rounded-md break-words",
