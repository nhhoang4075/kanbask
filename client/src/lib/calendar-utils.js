...
const PRIORITY_CLASSES = {
  low: "!rounded-sm !bg-green-100 !border-l-4 !border-green-700 !m-2",
  medium: "!rounded-sm !bg-amber-100 !border-l-4 !border-amber-700 !m-2",
  high: "!rounded-sm !bg-red-100 !border-l-4 !border-red-700 !m-2",
  default: "!rounded-sm !bg-slate-100 !border-l-4 !border-slate-700 !m-2"
};
...
export function getPriorityClass(priority) {
  return PRIORITY_CLASSES[priority || "default"] || PRIORITY_CLASSES.default;
}
...
function createEventDetailModal(clickInfo) {
  ...
  detailPopup.className =
    "bg-white shadow-xl rounded-lg p-5 w-11/12 max-w-xl h-auto max-h-[90vh] overflow-hidden flex flex-col";
