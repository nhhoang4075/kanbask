  ...
  return (
    <div className="flex flex-col gap-1 items-center justify-center">
      <Avatar className="flex-none h-20 w-20">
        ...
        <AvatarFallback>
          {selectedConversationId?.title ? selectedConversationId?.title.charAt(0) : "G"}
        </AvatarFallback>
      </Avatar>
      <div className="flex-none font-roboto text-xl">
        {selectedConversationId?.title ||
          (selectedConversationId?.type === "direct"
            ? "Direct Message"
            : selectedConversationId?.type === "team"
            ? "Team Chat"
            : "Project Chat")}
      </div>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              ...
              <DialogContent className="w-80">
                ...
                <DialogDescription className="text-sm text-gray-500">
                  You will not receive notifications for this conversation. You can unmute it at any
                  time.
                </DialogDescription>
                <FormField
