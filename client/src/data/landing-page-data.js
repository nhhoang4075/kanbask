    ...
    <div className="h-full w-full bg-white/30 backdrop-blur-xs rounded-lg p-1.5">
      <div className="flex gap-1 h-full text-[8px]">
        <div className="bg-blue-50/80 rounded p-1 flex-1 flex flex-col">
          ...
          <div className="bg-white shadow rounded p-0.5 mb-0.5 border-l-2 border-blue-400 group-hover:animate-pulse cursor-grab">Task #1</div>
          <div className="bg-white shadow rounded p-0.5 border-l-2 border-red-400 cursor-grab">Bug Fix</div>
        </div>
        <div className="bg-blue-50/80 rounded p-1 flex-1 flex flex-col">
          <div className="font-medium mb-0.5">In Progress</div>
          <div className="bg-white shadow rounded p-0.5 border-l-2 border-yellow-400 cursor-grab">Feature</div>
        </div>
        <div className="bg-blue-50/80 rounded p-1 flex-1 flex flex-col">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="mt-auto text-[5px] text-center">
            ...
            <span className="text-gray-500">
              Storage: <span className="group-hover:hidden">45%</span><span className="hidden group-hover:inline">100%</span>
            </span>
          </div>
        </div>
      </div>
...
export const featureCards = [
  {
    ...
    description: "Move tasks across your workflow with a simple gesture. Our intuitive interface makes task management effortless, letting you focus on what matters most.",
  ...
  },
  {
    ...
    description: "See updates instantly without refreshing. Keep your entire team in sync with live changes that ensure everyone stays on the same page.",
  ...
  },
  {
    ...
    description: "Identify bottlenecks and optimize productivity through visual data insights. Make informed decisions with charts that reveal the health of your projects.",
  ...
  },
  {
    ...
    description: "Efficient notification system ensures nothing falls through the cracks, keeping everyone accountable. Get notified about task updates and mentions without the noise.",
  ...
  },
  {
    ...
    description: "Stay connected with your team through built-in messaging across all project spaces. Discuss tasks without ever leaving your workflow.",
    href: "/features/chat",
    cta: "Learn more",
  ...
  },
  {
    Icon: Cloud,
    name: "Cloud Sync",
    description: "Secure cloud storage keeps your data safe and accessible anywhere. Collaborate seamlessly across devices with real-time synchronization.",
...
export const testimonials = [
  {
    quote: "Kanbask has completely transformed how our team collaborates. The real-time updates and intuitive interface have boosted our productivity by 30%.",
    author: "Sarah Johnson",
    title: "Product Manager, Acme Inc.",
    avatar: "/images/sarah.jpg"
  },
  {
    quote: "The analytics features alone are worth the price. We've identified and eliminated multiple workflow bottlenecks that were costing us hours each week.",
    author: "Michael Chen",
    title: "CTO, TechStart",
    avatar: "/images/michael.jpg"
  },
  {
    quote: "Our remote team stays perfectly in sync thanks to Kanbask. The integrated chat and task management is a game-changer for cross-functional projects.",
