...
import EditMember from "./Teams/MemberDataTable/EditMember";
import AddMember from "./Teams/MemberDataTable/AddMember";
      ...
      <div className="flex flex-row justify-between h-fit align-center py-2">
        ...
        <div className="flex flex-row justify-end gap-3 my-2">
          {table.getSelectedRowModel()?.rows.length == 1 &&
            (manage == "project" ? (
              <EditProject project={table.getSelectedRowModel()?.rows[0]} />
            ) : (
