...
const userIdParamSchema = Joi.object({
  userId: Joi.string().uuid({ version: 'uuidv4' }).required().messages({ // Specify UUID version if needed
...
export const validateAdminUpdateProfile = validate(adminUpdateProfileSchema, 'body');
...
export const validateResendVerification = validate(resendVerificationSchema, 'body');